...
This brief will informally attempt to cover key concerns regarding availability when designing architectures that leverage interconnection with the Equinix Fabric. This document is not intended to be exhaustive or complete, it also seeds authority to any / other official documentation. 

This document also assumes an *unreasonable* amount of domain and operator knowledge and experience. Please contact Equinix Metal Support or your Equinix account team for additional guidance if any of this document is unclear.

## Summary



While cloudy-nature of Virtual Circuits provides significant advantages, the additional abstractions in implementation of the product do introduce additional or specific concerns when designing availability conscious Interconnection architectures, that may be different from more traditional interconnection mediums or may be specific to the integration between Equinix Metal and Equinix Fabric
...
1. #### Customer has configured Colocation
...
2. #### Customer has configured Metal
...
3. #### Customer has configured Fabric 
  ...
  - The switch in [*Step 1*](Customer has configured Colocation) is connected to the [Equinix Fabric via cross-connect](https://docs.equinix.com/en-us/Content/Interconnection/Fabric/Fabric-landing-main.htm) and [Fabric Ports](https://docs.equinix.com/en-us/Content/Interconnection/Fabric/ports/Fabric-port-details.htm)
  ...
  - This virtual circuit is completed with the "Fabric Ports" associated with [Step 1](#Customer has configured Colocation) of this [scenario as the A-side](https://docs.equinix.com/en-us/Content/Interconnection/Fabric/layer-2/Fabric-layer-2-connections.htm)

4. #### Customer has configured A & Z-Side of Virtual Circuit 
  - The switch associated with the [*1st Step*](#Customer has configured Colocation) have been configured to receive the VLAN carried by the virtual circuit as configured in the provisioned of the Virtual Circuit VLANID
...
5. #### Customer has configured route advertisement
